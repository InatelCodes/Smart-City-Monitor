...
class DashboardControllerTest {
    ...
    void executaParaEConsolidaUmExperimentoReal() throws InterruptedException {
        ...
        controller.iniciar(new ConfiguracaoExperimento(1, 100));
    ...
    void resetLimpaLeiturasMasPreservaPossibilidadeDeNovaExecucao() throws InterruptedException {
        DashboardController controller = new DashboardController();
        controller.iniciar(new ConfiguracaoExperimento(2, 20));
        Thread.sleep(120);
        controller.parar();
        controller.resetar();
        ...
        controller.iniciar(new ConfiguracaoExperimento(4, 10));
